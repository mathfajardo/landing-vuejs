    ...
    <div id="features" class="py-6 px-6 lg:px-20 mt-8 mx-0 lg:mx-20">
        <div class="grid grid-cols-12 gap-4 justify-center">
            <div class="col-span-12 text-center mt-20 mb-6">
                ...
                <span class="text-muted-color text-2xl">Projetado com tecnologias de ponta</span>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <span class="text-surface-600 dark:text-surface-200">Painel fácil com suporte técnico
                            especializado</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pb-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Boa
                            documentação</div>
                        <span class="text-surface-600 dark:text-surface-200">Material completo caso tenha
                            duvidas.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Layout
                            Responsivo</div>
                        <span class="text-surface-600 dark:text-surface-200">Pode ser acessado por computador, tablet e
                            celular.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">IA
                            Personalizada
                        </div>
                        <span class="text-surface-600 dark:text-surface-200">Cada cliente tem sua IA personalizada de
                            acordo com o modelo do seu negócio.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pb-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Modo escuro
                        </div>
                        <span class="text-surface-600 dark:text-surface-200">Do jeito que preferir.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Pronto para
                            usar
                        </div>
                        <span class="text-surface-600 dark:text-surface-200">Implantação em até 2 dias</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Painel Kanban
                        </div>
                        <span class="text-surface-600 dark:text-surface-200">Acompanhe seus leads de forma clara e
                            organizada.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg-4 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">IA Treinada
                            para seu Negócio</div>
                        <span class="text-surface-600 dark:text-surface-200"> Cada cliente recebe uma IA personalizada
                            conforme seu modelo de atendimento e vendas.</span>
                    </div>
                </div>
            </div>

            <div class="col-span-12 mt-20 mb-20 p-2 md:p-20" style="border-radius: 20px; background:
...
">
                <div class="flex flex-col justify-center items-center text-center px-4 py-4 md:py-0">
                    <div class="text-gray-900 mb-2 text-3xl font-semibold">Josiani Gisele</div>
                    <span class="text-gray-600 text-2xl">Consultora</span>
                    <p class="text-gray-900 sm:line-height-2 md:line-height-4 text-2xl mt-6" style="max-width: 800px">
                        “Como consultora de vendas da empresa, vejo diariamente o impacto positivo do painel nos nossos
                        clientes. Eles destacam a facilidade de uso, a organização dos leads e o ganho de produtividade.
                        É muito satisfatório acompanhar tantos resultados positivos e clientes realmente satisfeitos com
                        a solução.”
                    </p>
                    <img src="/favicon.ico" class="mt-6 h-20" alt="Company logo" />
                </div>
            </div>
        </div>
    </div>
